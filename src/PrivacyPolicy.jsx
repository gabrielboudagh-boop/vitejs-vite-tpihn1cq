...
export default function PrivacyPolicy() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "'DM Sans', sans-serif" }}>
      <SEO 
        title="Privacy Policy | Vima Vima" 
        description="Vima Vima's privacy policy — how we collect, use, and protect your data while you prepare for USMLE, MCAT, and LSAT." 
